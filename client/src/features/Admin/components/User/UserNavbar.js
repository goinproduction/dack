                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="me-auto">
                        ...
                        {isAuthenticated ? (<NavDropdown title="Trở thành đối tác" id="collasible-nav-dropdown">
                            <NavDropdown.Item onClick={() => redirect('/seller-register')} >Đăng ký bán hàng</NavDropdown.Item>
                            <NavDropdown.Divider />
                            <NavDropdown.Item onClick={() => redirect('/shipper-register')}>Đăng ký giao hộ</NavDropdown.Item>
                        </NavDropdown>) : null}
                    </Nav>
                    {isAuthenticated ? (<Nav>
                        ...
                        <Nav.Link className='link' onClick={() => redirect('/login')}>Đăng nhập</Nav.Link>
                        <Nav.Link className='link' onClick={() => redirect('/register')}>
                            Đăng ký
                        </Nav.Link>
                    </Nav>)
                    }
